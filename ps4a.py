...
def getWordScore(word, n):
    ...
    for l in word:
        score += SCRABBLE_LETTER_VALUES[l] * len(word)
    ...
    while True:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                # Update the hand 
                currentHand = updateHand(currentHand, userInput)
                print('"' + userInput +'" earned ' + str(getWordScore(userInput, n)) + " points. Total: " + str(total) + " points.")

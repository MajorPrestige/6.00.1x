...
def playGame(wordList):
    ...
    while True:
        ...
        if userInput == 'e':
            ...
            while True:
                if userInput == 'r' and not currentHand:
                    print("You have not played a hand yet. Please play a new hand first!")
                    break
                
                userInputChooseGame = input('Enter u to have yourself play, c to have the computer play: ')
                
                if userInputChooseGame == 'c':
